...
![image](https://user-images.githubusercontent.com/7136948/154296597-04378c63-1d66-4aa2-b423-859e80532dfd.png|width=100px)
...
If you use linux you can also try Windows version ```wine GCB_Installer-98.exe```. However, if you want pure-Linux you need to work a little bit more. First you need to download and install FreeBasic from https://sourceforge.net/projects/fbc
